...
def train_vector(items, w2v_prefix, embedding_dim=None, method="sg", binary=None, train_params=None):
    ...
    >>> print(token_item[:10])
    [['公式'], [\\FormFigureID{1}], ['如图'], ['[FIGURE]'],...['最大值'], ['[MARK]']]
    >>> train_vector(token_item[:10], "examples/test_model/data/w2v/gensim_luna_stem_t_", 100) #doctest: +ELLIPSIS
    'examples/test_model/data/w2v/gensim_luna_stem_t_sg_100.kv'
    """
